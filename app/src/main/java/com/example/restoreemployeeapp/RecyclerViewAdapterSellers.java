...
public class RecyclerViewAdapterSellers extends RecyclerView.Adapter<RecyclerViewAdapterSellers.ViewHolder> {
  ...
  // private PassData passData; // Interface to pass data from adapter to Coworker fragment
    ...
    public RecyclerViewAdapterSellers(Context context, List<User> list/*, PassData passData*/)
    {
        try {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        ...
        View view = inflater.inflate(R.layout.card_layoutsellers, null);// inflates the cardview layout
    ...
    @Override
    public void onBindViewHolder(@NonNull final RecyclerViewAdapterSellers.ViewHolder holder, int position) {
